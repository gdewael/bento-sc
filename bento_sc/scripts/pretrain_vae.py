...
from bento_sc.baselines import VAE
...
def main():
    ...
    parser.add_argument("--beta", type=float, default=None, help="Beta value in loss. Overrides value in config file if specified")
